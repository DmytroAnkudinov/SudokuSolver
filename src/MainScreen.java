...
public class MainScreen extends Screen implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (selectedBoardField != null)
		{
			...
			{
				if (MainScreen.this.isCandidatesEnabled && ((e.getModifiersEx() & KeyEvent.SHIFT_DOWN_MASK) == KeyEvent.SHIFT_DOWN_MASK))
